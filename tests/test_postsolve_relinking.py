...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("max_edge_cost", "6.0"),
        ("max_edge_cost", np.str_("6.0")),
        ("max_edge_cost", np.array("6.0", dtype=object)),
        ...
        ("min_cost_improvement", np.str_("0.25")),
        ("min_cost_improvement", np.array("0.25", dtype=object)),
        ...
        ("bidirectional_next_weight", "1.0"),
        ("bidirectional_next_weight", np.str_("1.0")),
        ("bidirectional_next_weight", np.array("1.0", dtype=object)),
    ],
)
