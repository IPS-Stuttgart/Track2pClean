...
@pytest.mark.parametrize("bad_index", [_BadIndex(), _HugeIndex()])
def test_build_track_rows_from_matches_normalizes_index_protocol_start_session_index(
    bad_index,
):
