...
def test_candidate_pruning_guard_reinstall_keeps_restored_wrapper(monkeypatch):
    original_candidate_mask = advanced_roi_components.candidate_mask_from_cost_matrix
