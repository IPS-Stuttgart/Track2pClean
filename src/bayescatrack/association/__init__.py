...
from . import _teacher_prior_index_validation as _teacher_prior_index_validation
from . import _teacher_prior_roi_token_validation as _teacher_prior_roi_token_validation
from . import (
...
_teacher_prior_index_validation.install_teacher_prior_index_validation()
_teacher_prior_roi_token_validation.install_teacher_prior_roi_token_validation()
...
_PATCH_MODULES = (
    ...
    _teacher_prior_roi_token_validation,
