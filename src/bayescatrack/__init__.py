...
from ._suite2p_iscell_validation import (
    install_suite2p_iscell_value_validation as _install_suite2p_iscell_value_validation,
)
...
_install_suite2p_iscell_value_validation(_bridge)
