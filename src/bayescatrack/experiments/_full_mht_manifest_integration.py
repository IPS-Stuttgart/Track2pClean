...
FULL_MHT_FIELDS = {
    ...
    "track2p_prior_anomaly_weight",
    "track2p_prior_anomaly_min_anchors",
    "track2p_prior_anomaly_min_anchor_registered_iou",
    "track2p_prior_anomaly_min_anchor_shifted_iou",
    "track2p_prior_anomaly_max_anchor_growth_residual",
...
def _full_mht_config_from_options(options: Mapping[str, Any]) -> Any:
    ...
    config = FullMHTConfig(
        ...
        track2p_prior_anomaly_weight=manifest._float_option(
            options,
            "track2p_prior_anomaly_weight",
            default=defaults.track2p_prior_anomaly_weight,
        ),
        track2p_prior_anomaly_min_anchors=manifest._positive_int_option(
            options,
            "track2p_prior_anomaly_min_anchors",
            default=defaults.track2p_prior_anomaly_min_anchors,
        ),
        track2p_prior_anomaly_min_anchor_registered_iou=manifest._float_option(
            options,
            "track2p_prior_anomaly_min_anchor_registered_iou",
            default=defaults.track2p_prior_anomaly_min_anchor_registered_iou,
        ),
        track2p_prior_anomaly_min_anchor_shifted_iou=manifest._float_option(
            options,
            "track2p_prior_anomaly_min_anchor_shifted_iou",
            default=defaults.track2p_prior_anomaly_min_anchor_shifted_iou,
        ),
        track2p_prior_anomaly_max_anchor_growth_residual=manifest._float_option(
            options,
            "track2p_prior_anomaly_max_anchor_growth_residual",
            default=defaults.track2p_prior_anomaly_max_anchor_growth_residual,
        ),
        track2p_prior_anomaly_max_anchor_growth_mahalanobis=manifest._float_option(
            options,
            "track2p_prior_anomaly_max_anchor_growth_mahalanobis",
            default=defaults.track2p_prior_anomaly_max_anchor_growth_mahalanobis,
        ),
        track2p_prior_anomaly_min_anchor_cell_probability=manifest._float_option(
            options,
            "track2p_prior_anomaly_min_anchor_cell_probability",
            default=defaults.track2p_prior_anomaly_min_anchor_cell_probability,
        ),
        track2p_prior_anomaly_min_feature_scale=manifest._float_option(
            options,
            "track2p_prior_anomaly_min_feature_scale",
        ...
        track2p_prior_anomaly_score_clip=manifest._float_option(
            options,
            "track2p_prior_anomaly_score_clip",
            default=defaults.track2p_prior_anomaly_score_clip,
        ),
